...
- **`src/` contains no writer of `display_name` at all** — grep for update/upsert/insert against that column returns nothing. Row `1.7`'s §1B.28.1 name-collection step is the missing writer, and it is unbuilt.
