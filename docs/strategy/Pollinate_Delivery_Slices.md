...
> - **Free tier:** Unlimited hives and entries forever; first delivery free forever; export free forever (V2 §17.4); receive unlimited. Sealing unconditional on every tier. Cadence, friends and seeds ungated everywhere (V2 §17.5.6 — delivery is the only meter; seeds abuse-rate-limited, not priced).
