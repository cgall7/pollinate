...
> - **Free tier:** Unlimited hives and entries forever; first delivery free forever; export free forever (V2 §17.4); receive unlimited. Sealing unconditional on every tier. Old friend/seed/cadence splits: flagged for ruling (V2 §17.5 does not address them).
