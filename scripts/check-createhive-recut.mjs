...
// acceptance rows in GUIDES/POLLINATE_CREATEHIVE_RECUT_SPEC.md §R-CH-6
// were run by hand three times (builder, ratifier, merger) and that is
// the only reason they held; this file is so the fourth reading is a
// machine's.
//
