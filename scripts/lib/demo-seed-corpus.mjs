...
export const STREAK_THEMES = [
  'Family', 'Friendship', 'Health', 'Nature', 'Growth', 'Career', 'Joy', 'Spirit', 'Creativity',
];
...
export const STREAK = [
  ...
  { text: 'I am grateful for a quiet hour with the phone in another room.', theme: 'Spirit' },
  ...
  { text: 'I am grateful for a Sunday with absolutely nothing written in it.', theme: 'Spirit' },
  ...
  { text: 'I sat in the garden for twenty minutes and did nothing else.', theme: 'Spirit' },
  ...
  { text: 'I am thankful nobody needed anything from me between six and nine.', theme: 'Spirit' },
  ...
  { text: 'I am grateful for silence in a house that is normally loud.', theme: 'Spirit' },
  ...
  { text: 'I am thankful for a morning with no obligations before eleven.', theme: 'Spirit' },
  ...
  { text: 'I am thankful for stillness in the flat at about half five.', theme: 'Spirit' },
  ...
  { text: 'I let a Sunday go by without earning anything from it.', theme: 'Spirit' },
  ...
  { text: 'I am thankful for the ten minutes before anybody else was awake.', theme: 'Spirit' },
  ...
  { text: 'I am grateful for an evening that went exactly nowhere.', theme: 'Spirit' },
  ...
  { text: 'I am thankful for an afternoon that felt like a Saturday.', theme: 'Spirit' },
  ...
  { text: 'I am thankful for a quiet Friday with the phone face down.', theme: 'Spirit' },
  ...
  { text: 'I sat with a hard feeling instead of doing something about it.', theme: 'Spirit' },
  ...
  { text: 'I am grateful for the quiet that arrives at about ten past nine.', theme: 'Spirit' },
