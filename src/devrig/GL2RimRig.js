...
// Alpha is FIXED at the ruled GlassView value; the swept axis is the rim.
export const VEIL = 0.35;
export const ALPHAS = [0, 1, 2, 3]; // bar slots: see RUNGS
export const RUNGS = [
  { material: 'glass', rim: true },
  { material: 'glass', rim: false },
  { material: 'blur', rim: true },
  { material: 'blur', rim: false },
];
...
export const GL2RimRig = () => {
  ...
  return (
    <View style={styles.root}>
      ...
      <Text style={styles.readout2}>{`veil=${VEIL} ground=${ground.key} rungs: glass+rim, glass-rim, blur+rim, blur-rim`}</Text>
      {ALPHAS.map((a, i) => (
