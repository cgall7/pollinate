...
export const CreateCombScreen = ({ navigation }) => {
  ...
  return <View style={styles.container}>
    ...
    <View style={styles.content}>
      ...
      <Text style={styles.title}>Gather your people.</Text>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: theme.colors.background }, header: { padding: 24, paddingTop: 56 }, content: { flex: 1, paddingHorizontal: 24, paddingBottom: 20 }, eyebrow: { ...theme.type.caption, color: theme.colors.inkSoft, letterSpacing: 1.2 }, title: { ...theme.type.h1, color: theme.colors.ink, marginTop: 10 }, input: { ...theme.type.bodyLg, color: theme.colors.ink, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.surfaceBorderStrong, borderRadius: theme.borderRadius.small, minHeight: 54, paddingHorizontal: theme.spacing.md, marginTop: 22 }, label: { ...theme.type.h3, color: theme.colors.ink, marginTop: 30 }, help: { ...theme.type.bodySm, color: theme.colors.inkSoft, marginTop: 6, marginBottom: 14 }, person: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, marginBottom: 10, borderRadius: theme.borderRadius.medium, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.surfaceBorder }, personSelected: { borderColor: theme.colors.accent, backgroundColor: theme.colors.washYellow }, personName: { ...theme.type.bodyLg, color: theme.colors.ink }, check: { ...theme.type.h3, color: theme.colors.ink }, footer: { padding: 24, borderTopWidth: 1, borderColor: theme.colors.surfaceBorder }, error: { ...theme.type.bodySm, color: theme.colors.inkSoft, marginBottom: 10 },
});
